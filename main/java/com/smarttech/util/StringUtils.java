...
public class StringUtils {
	...
	public static final String LOCALHOST_URL = "jdbc:mysql://localhost:3308/SmartTech";
	...
	public static final String IMAGE_DIR_PRODUCT = "/Users/salinaTheeng/Desktop/SmartTech/src/main/webapp/resources/images/products/";
	public static final String IMAGE_DIR_SAVE_PATH =  File.separator + IMAGE_DIR_PRODUCT;
	public static final String IMAGE_DIR_USER = "/Users/salinaTheeng/Desktop/Smartech/src/main/webapp/resources/images/users/";
	...
	// Start: JSP Route
	//page URLs
	public static final String BASE_URL = "WEB-INF/pages";
	public static final String PAGE_URL_LOGIN = BASE_URL+ "/login.jsp";
	public static final String PAGE_URL_SIGNUP = BASE_URL+ "/signup.jsp";
	public static final String PAGE_URL_FOOTER =BASE_URL+ "/footer.jsp";
	public static final String PAGE_URL_HEADER =BASE_URL+ "/header.jsp";
	public static final String PAGE_URL_ADMIN =  BASE_URL+"/admin.jsp";
	public static final String PAGE_URL_HOME = "/home.jsp";
	public static final String URL_LOGIN = BASE_URL+ "/login.jsp";
	public static final String URL_PRODUCTS = BASE_URL+ "/products.jsp";
	public static final String URL_INDEX = BASE_URL+ "/home.jsp";
	// End: JSP Route
	...
	public static final String SERVLET_URL_PRODUCTS = "/products";
	
	// End: Servlet Route
	
	// ... [existing content from your provided code remains unchanged above]

	// Start: Session Attributes
	public static final String SESSION_USERNAME = "loggedInUser";
	public static final String SESSION_CART = "userCart";
	public static final String SESSION_ADMIN = "adminUser";
	public static final String SESSION_ROLE = "userRole";
	public static final String SESSION_TIMEOUT_MSG = "Your session has expired. Please log in again.";
	// End: Session Attributes

	// Start: Cookie Names
	public static final String COOKIE_USERNAME = "rememberedUser";
	public static final String COOKIE_ROLE = "userRole";
	public static final String COOKIE_SESSION_ID = "sessionId";
	// End: Cookie Names

	// Start: Redirection Keywords
	public static final String REDIRECT_HOME = "redirect:/home.jsp";
	public static final String REDIRECT_LOGIN = "redirect:/login.jsp";
	public static final String REDIRECT_ADMIN = "redirect:/admin.jsp";
	public static final String REDIRECT_LOGOUT = "redirect:/logout";
	public static final String REDIRECT_ERROR = "redirect:/error.jsp";
	// End: Redirection Keywords
	...
	public static final String SESSION_REDIRECT_URL = null;
	public static final String ADMIN_ROLE = null;
}